$(function() {
	$('.list2 .list2-ul li').click(function() {
		$('.list2 .list2-ul li').removeClass('active');
		$(this).addClass('active');
		var index = $(this).index();

		$('.list2 .content').removeClass('active');
		$('.list2 .content').eq(index).addClass('active');
	});

	$('.third .list-group li').click(function() {
		$('.third .list-group li').removeClass('active');
		$(this).addClass('active');

		var index = $(this).index();
		$('.third .chart').removeClass('active');
		$('.third .chart').eq(index).addClass('active');
	});
	
	$('.four .yvshen li').click(function() {
		$('.four .yvshen li').removeClass('active');
		$(this).addClass('active');
		var index = $(this).index();
		$('.four .yvshen-content .content').removeClass('active');
		$('.four .yvshen-content .content').eq(index).addClass('active');
	});
